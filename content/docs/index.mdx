---
title: Introduction
description: Stablecoin intelligence for Tempo — every peg, every policy, every flow.
---

Pellet is the stablecoin intelligence layer for Tempo. We monitor every TIP-20 stablecoin on the chain — peg stability, supply dynamics, cross-pair flows, compliance policies, role holders, and backing structure — and expose the data through a REST API, an MCP server, and a web explorer.
