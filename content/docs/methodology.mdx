...
This document specifies how OLI decodes Tempo activity and how Pellet Wallet enforces caps. Versioned so changes don't silently mutate historical interpretations.

**OLI methodology version: 0.2** *(2026-04-29)*
**Wallet methodology: Phase 4 / 5 release (testnet)** *(2026-04-29)*

For the rendered version with sidebar navigation, see [pellet.network/oli/methodology](/oli/methodology).

---

## OLI — Open-Ledger Interface

### Scope

OLI's lens is the public Tempo ledger:
...
- OLI queries: [`lib/oli/queries.ts`](https://github.com/pelletnetwork/pellet/blob/main/lib/oli/queries.ts)
- OLI ingestion: [`lib/ingest/`](https://github.com/pelletnetwork/pellet/tree/main/lib/ingest)
