...
Every value returned here is an **Open-Ledger Intelligence (OLI)** measurement — read directly from the Tempo public ledger, never aggregated from off-chain oracles. See [What is OLI?](/docs/oli) for the discipline, and [Methodology](/docs/methodology) for the exact formulas behind each field.
