---
title: REST API
description: HTTP endpoints for Pellet read queries and Wallet operations. Hosted at https://pellet.network.
icon: Terminal
---
...
Live observability over autonomous economic activity on Tempo. See [Methodology](/docs/methodology).
...
- API endpoints: [`app/api/`](https://github.com/pelletnetwork/pellet/tree/main/app/api)
