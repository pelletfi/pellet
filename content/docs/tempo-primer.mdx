...
Pellet uses MPP for paid endpoints in USDC.e on Tempo — tiered from $0.010 lookups to $0.200 deep briefings, settled at the protocol layer. No accounts, no API keys, no rate limits beyond what the payment graph enforces.
