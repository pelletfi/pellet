...
export function LeaderboardClient({
  ...
  return (
    <div className="wallet-leaderboard">
      <div className="wallet-leaderboard-title">
        <span>{title}</span>
      ...
      <div className="wallet-leaderboard-table">
        {/* Header */}
        <div
          className="wallet-leaderboard-row wallet-leaderboard-header"
        ...
        {rows.map((row, idx) => {
          ...
          const inner = (
            ...
            >
              ...
              {hasChevron ? (
                <span
                  className="wallet-leaderboard-chevron"
                  style={{
                    fontFamily: "var(--font-mono)",
                    fontSize: 14,
                    color: "var(--color-text-quaternary)",
          ...
          return row.href ? (
            <Link key={row.id} href={row.href} className="wallet-leaderboard-link">
              {inner}
            </Link>
          ) : (
