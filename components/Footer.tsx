...
const socialLinks = [
  ...
  { label: "CLI", href: "https://www.npmjs.com/package/@pelletnetwork/cli" },
];
      ...
      <div className="footer-inner">
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          >
            ...
            <span style={{ fontFamily: "var(--font-sans)", color: "var(--color-text-quaternary)" }}>
              © {new Date().getFullYear()} Pellet Network. All rights reserved.
            </span>
          </div>
        </div>
