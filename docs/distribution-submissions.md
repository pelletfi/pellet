...
```markdown
- [pellet](https://github.com/pelletfi/pellet) - Stablecoin intelligence on Tempo. Peg health, risk scores, reserves, role holders, peg-break detection. Free + MPP-paid tools.
```
...
> Stablecoin intelligence for Tempo. Live peg health, composite risk scores, backing reserves, forensically-derived role holders, peg-break events. Free tools + MPP-paid deep briefings.
...
### /defi channel
> Built a stablecoin intelligence layer for Tempo (the Stripe-backed L1).
>
...
**Description:**
> Pellet is the stablecoin intelligence layer for Tempo. Live peg health, composite risk scores, backing reserves, role holders, and cross-stable flow anomaly detection — refreshed continuously across all 12 TIP-20 stables.
