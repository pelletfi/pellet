 ...
 * ```
 */
export declare function defineConfig<const methods extends Mppx.Methods | undefined = undefined>(config: defineConfig.Config<methods>): defineConfig.Config<methods>;
